...
<a href='delivery_person_see_order_details.php?see_order_details=$order_id&cust_id=$cust_id' class='fun btn btn-secondary col-12 mb-2'>See Order Details </a>";
                                ...
                                // echo '<a href="delivery_person_see_order_details.php" class="bg-info p-3 py-2 border-0 mx-3 text-dark" style="display: inline-block; text-decoration: none;">Back</a>';
                            }
